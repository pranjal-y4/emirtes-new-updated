                    ...
                    <section id="first-tab-group" class="tabgroup">
                        <div id="tab1">
                            <div class="submit-form">
								...
								<?php
									if(!empty($_SESSION['userid']) && !empty($_SESSION['status'])){
										echo '<h2 style="color: red;">'.$_SESSION['status'].'</h2>';
										session_unset();
									}
								?>
                                <h4 style="color: black;">Check availability for direction:</h4>
                                <form id="form-submit" action="search.php" method="POST">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <fieldset>
                                                <button type="submit" name="submit" id="form-submit" class="btn">Order Ticket Now</button>
                                            </fieldset>
                                        </div>
                                    </div>
                                </form>
