                    ...
                    <section id="first-tab-group" class="tabgroup">
                        <div id="tab1">
                            <div class="submit-form">
                                <h4 style="color: black;">Signup Now </h4>

    <form name="f1" action = "includes/signup.inc.php" method = "POST">
  <div class="signup-form-form">
    <table>
        <tr>
            <td><b>Full Name</b></td>
            <td><input type="text" placeholder="Full Name" name="name" required><br></td>
        </tr>
        <tr>
            <td><b>Email</b></td>
        ...
        <tr>
            <td><b>UID</b></td>
            <td><input type="text" placeholder="Uid" name="uid" required><br></td>
        </tr>
        <tr>
            <td><b>Password</b></td>
            <td><input type="password" placeholder="Enter Password" name="pwd" required><br></td>
        </tr>
        <tr>
            <td><b>Re-Enter Password</b></td>
            <td><input type="password" placeholder="Password" name="pwdrepeat" required><br></td>
        </tr>
    </table>
    <br>


    <button type="submit" name="submit" style="background-color:red; height: 50px; width: 350px;">SignUp</button>
    <label>
    </label>
  </div>
    </div>
